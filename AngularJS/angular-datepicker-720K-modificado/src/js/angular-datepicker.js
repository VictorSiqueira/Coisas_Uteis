        ...
        datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate) {
            ...
            var linkingFunction = function linkingFunction($scope, element, attr) {
                ...
                var selector = attr.selector,
                    ...
                    thisCaller = angular.element(caller ? element[0].querySelector('.' + caller) : thisInput),
                ...
                thisCaller.on('focus click focusin', function onFocusAndClick() {
                    isMouseOnInput = true;
                ...
                ////REMOVE
                /*thisCaller.on('focusout blur', function onBlurAndFocusOut() {
                    isMouseOnInput = false;
                });
